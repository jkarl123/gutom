...
public class LoginDSB extends javax.swing.JFrame {
    ...
    public LoginDSB() {
       ...
       public static boolean loginAccount(String username, String password) {
        try (Connection cn = new DBConnector().getConnection()) {
            ...
            PreparedStatement checkStmt = cn.prepareStatement("SELECT COUNT(*) FROM james WHERE user = ? AND pass = ? AND status = 'Active'");
      ...
      public static void showTable(DefaultTableModel table) {
        ...
        try {
            ...
            ResultSet rs = new DBConnector().getData("SELECT * FROM james");
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 330, 52));
